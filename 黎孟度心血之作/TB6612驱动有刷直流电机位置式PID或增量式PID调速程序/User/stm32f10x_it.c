...
int Target_velocity1=50;                     //设定电机1的目标速度
int Target_velocity2=20;                     //设定电机2的目标速度
#endif
...
void TIM3_IRQHandler(void)
{
	...
	//检查指定的TIM3中断发生与否
		{	
			...
			//电机1
			//通过增量式PID算法计算出PWMA的值并赋值给变量Moto1
			...
			//电机2
			//通过增量式PID算法计算出PWMB的值并赋值给变量Moto2
