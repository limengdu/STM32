  ...
  for (k=0;k<8;k++)        //每组数据有8位
  {
   ...
   { 
     return; }
		 ...
		 {
			 case 0x46: a=2;break;
			 case 0x15: {ctrl_comm = COMM_STOP;a=0;break;}
			 case 0x44: {ctrl_comm = COMM_STOP;a=0;break;}
			 case 0x43: {ctrl_comm = COMM_STOP;a=0;break;}
			 case 0x40: {ctrl_comm = COMM_STOP;a=0;break;}
			 default :  return;
		 }
		 ir_rec_flag = 1;
