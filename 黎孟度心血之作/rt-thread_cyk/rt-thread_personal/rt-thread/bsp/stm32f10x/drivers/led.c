...
#define red_rcc                    RCC_APB2Periph_GPIOE
#define red_gpio                   GPIOE
...
void rt_hw_led_init(void)
{
    ...
    RCC_APB2PeriphClockCmd(led1_rcc|led2_rcc|red_rcc,ENABLE);
...
void rt_hw_led_off(rt_uint32_t n)
{
    ...
    case 1:
        ...
        break;
    case 2:
        GPIO_ResetBits(red_gpio, red_pin);
        break;
    default:
        break;
    }
