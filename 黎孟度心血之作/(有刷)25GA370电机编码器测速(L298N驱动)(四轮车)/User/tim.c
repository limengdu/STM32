...
/*******************************************************************************
* 函 数 名         : DCMOTOR_BRUSH_TIMx_GPIO_Config
 ...
 */
/*******************************************************************************
* 函 数 名         : DCMOTOR_BRUSH_TIMx_Configuration
...
/*******************************************************************************
* 函 数 名         : DCMOTOR_BRUSH_TIMx_PWM_Init
...
{
	DCMOTOR_BRUSH_TIMx_GPIO_Config();   //配置TIMx复用输出PWM时用到的I/O
	DCMOTOR_BRUSH_TIMx_Configuration();	//配置TIMx输出的PWM信号的模式
}

/*******************************************************************************
* 函 数 名         : DCMOTOR_25GA370_Contrl
* 函数功能		   : 直流电机控制
* 输    入         : 无
* 输    出         : 无
* 说    明         ：参数number：电机编号，支持三个电机驱动(只开了通道1)
*                    值        ：1——对应高级定时器通道1和互补通道1
*                                2——对应高级定时器通道2和互补通道2
*                                3——对应高级定时器通道3和互补通道3
*                                4——使能三个电机转动
*                                5——三个电机都停机
